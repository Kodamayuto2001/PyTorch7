...
class Net(nn.Module):
    def __init__(self):
        ...
        self.fc1 = torch.nn.Linear(256*256, 1000)
        self.fc2 = torch.nn.Linear(1000, 101)
...
if __name__ == "__main__":
    ...
    #データローダーを取得
    mDataLoader = MyDataLoader(trainRootDir="data/train",testRootDir="data/test/",imgSize=256,batchSize=128)
    mDataLoader.imshow()
